...
from src.datasets.MONN import MONNData
from torch_geometric.data import Batch
from common.src.datasets.utils import BatchSeq
...
class DataSet(CARADatasetMeta, MONNData):
    """
    ...
    def get_one_sample(self, sample_idx):
        ...
        x_spt[1] = BatchSeq(x_spt[1])
        x_qry[0] = Batch.from_data_list(x_qry[0])
        x_qry[1] = BatchSeq(x_qry[1])
